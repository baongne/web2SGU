  ...
  <div id="body" style=" height: fit-content;margin-top: 50px;">
    <div class="containerlogin-containerlogin">
      <div style="width: 40%;height: 100%;display:flex;flex-direction:column;align-items:center;justify-content:center;">
        <img src="assets/img/hoangImg/logo/logo_tron.png" alt="z416347160358228d6ce2e5edbcf0ee0b207d1a4329bed23772" class="containerlogin-z416347160358228d6ce2e5edbcf0ee0b207d1a4329bed2" onclick="">
      ...
      <form style="width: 60%;height: 100%;display:flex;flex-direction:column;align-items:center;justify-content:center;" name="frmdangky" id="" action=".//modules/signup_processing.php" method="POST" onsubmit="return kiemTra();">
        ...
        <div class="containerlogin-group1">
          ...
          <div>
            ...
            <input name="fullName" type="text" style="padding-left: 6px;width:320px; height:36px;  border-style: outset;margin-bottom: 12px; border: 1px solid #674FA3; border-radius: 8px;margin-right: 16px;" placeholder="Họ và tên">
          </div>
          <div>
            ...
            <input id="email" name="email" type="email" style="padding-left: 6px;width:320px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #674FA3; border-radius: 8px;" placeholder="Email">
          </div>
          <div>
            <div style="display: flex; flex-direction:row ;width: fit-content;">
            ...
            <input id="numberPhone" name="numberPhone" type="text" style="padding-left: 6px;width:320px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #674FA3; border-radius: 8px;" placeholder="Số điện thoại">
          </div>
          <div>
            <div style="display: flex; flex-direction:row ;width: fit-content;">
              <p style="margin-bottom: 4px;">Mật khẩu (*)</p>
              <p id="pass-message" style="display: none; color: red;padding-left: 10px;font-size: 12px;font-weight: bold;line-height: 18.391px;">
                aa</p>
            </div>

            <input id="password" name="passWord" type="password" style="padding-left: 6px;width:320px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #674FA3; border-radius: 8px;" placeholder="Mật khẩu" maxlength="20">
          </div>
          <div>
            <div style="display: flex; flex-direction:row ;width: fit-content;">
              <p style="margin-bottom: 4px;">Nhập lại mật khẩu (*)</p>
              <img id="khongtrungkhop" src="assets/img/hoangImg/icons/icons8-cancel-48.png" alt="" width="20px" height="20px" style="margin-left: 10px;display: none;">
              <img id="trungkhop" src="assets/img/hoangImg/icons/icons8-ok.gif" alt="" width="20px" height="20px" style="margin-left: -20px;display: none;">
            </div>
            <input id="repeatPassword" name="repeatPassword" type="password" style="padding-left: 6px;width:320px; height:36px; border-style: outset; border: 1px solid #674FA3; border-radius: 8px;margin-bottom: 20px;" placeholder="Nhập lại mật khẩu" maxlength="20">
          </div>
          ...
          <div>
            <p style="margin-top: 30px;">Địa chỉ nhận hàng (*)</p>
            <input name="diaChiNha" type="text" style="padding-left: 6px;width:332px; height:36px; border-style: outset;margin-bottom: 34px; border: 1px solid #674FA3; border-radius: 8px;" placeholder="Số nhà, đường">
          </div>
          <div style="width: 500px; display: flex; justify-content: center; margin-top: 20px;">
            <!-- Đoạn mã button với chỉnh sửa trực tiếp -->
            <input type="submit" id="btnSubmitLogin" class="containerlogin-text06 LabelLarge" value="Đăng ký" style="width: 200px; height: 60px; font-size: 24px;">
          </div>
